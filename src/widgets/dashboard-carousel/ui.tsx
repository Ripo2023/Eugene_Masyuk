...
export const DashboardCarousel: React.FC<IDashboardCarouselProps> = ({
	navigation,
}) => {
	...
	const handleGetStepComponent = () => {
		switch (activeStep) {
			case 0:
				return <DashBoardFirstStep />;
			case 1:
				return <DashBoardSecondStep />;
			case 2:
				return <DashBoardThirdStep />;
			case 3:
				return <DashBoardFourthStep />;
			default:
				return <DashBoardFirstStep />;
		}
	};
...
const DashBoardSecondStep = () => {
	return (
		<StepWrapper entering={SlideInRight.duration(500)}>
			...
			<Title>Search for a coffee shop</Title>
			<SubTitle>
				The map shows the nearest coffee shops to you, choose the most
				convenient one for you. The app will tell you how long to go to it.
			</SubTitle>
		</StepWrapper>
	);
};
	...
	return (
		<StepWrapper entering={SlideInRight.duration(500)}>
			...
			<SubTitle>
				...
				You can choose their composition and choose the time when it will be
				convenient for you to pick them up
			</SubTitle>
		</StepWrapper>
	);
};
